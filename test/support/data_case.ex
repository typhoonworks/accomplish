defmodule Accomplish.DataCase do
  @moduledoc """
  ...
  by setting `use Accomplish.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Accomplish.Repo, shared: not tags[:async])

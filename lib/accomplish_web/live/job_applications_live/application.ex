defmodule AccomplishWeb.JobApplicationsLive.Application do
      ...
      <div class="mt-8 w-full">
        <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
          <%= case @live_action do %>
            ...
            <% :documents -> %>
              <.live_component
                module={AccomplishWeb.JobApplications.DocumentsComponent}
  ...
  def mount(%{"slug" => slug}, _session, %{assigns: %{live_action: :documents}} = socket) do
    with {:ok, socket, application} <- fetch_application(socket, slug) do
      socket =
        socket

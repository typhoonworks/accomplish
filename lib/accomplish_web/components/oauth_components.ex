defmodule AccomplishWeb.Components.OAuthComponents do
  @moduledoc false

  use Phoenix.Component

  attr :google_path, :string, default: "#"
  attr :github_path, :string, default: "#"

  def oauth_providers(assigns) do
    ~H"""
    <div class={[
      "mt-6 grid grid-cols-1 gap-4",
      FunWithFlags.enabled?(:show_dev_ui) && "grid-cols-2"
    ]}>

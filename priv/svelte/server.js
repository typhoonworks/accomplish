...
function Example($$payload, $$props) {
  ...
  $$payload.out += `<p>`;
  push_element($$payload, "p", 26, 2);
  $$payload.out += `The number is ${escape_html(number)}</p>`;
  pop_element();
  $$payload.out += ` <button>`;
  push_element($$payload, "button", 27, 2);
  $$payload.out += `+</button>`;
  pop_element();
  $$payload.out += ` <button>`;
  push_element($$payload, "button", 28, 2);
  $$payload.out += `-</button>`;
  pop_element();
  $$payload.out += `</div>`;
  pop_element();
